...
const renderTask = (taskData, container, isComplete = false) => {
  ...
  // If no available Task
  // Hide "No task available" span in this container, if visible
  const noAvailableSpan = container.querySelector("span");
  if (noAvailableSpan) {
    noAvailableSpan.style.display = "none";
  }
  ...
  taskDiv.innerHTML = `
      <div class="title-date">
        ...
        <p class="description ${isComplete ? "completed" : ""}">${
